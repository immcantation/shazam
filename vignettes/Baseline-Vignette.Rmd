...
fontsize: 11pt
vignette: |
  %\VignetteIndexEntry{Selection quantification}   %\VignetteEngine{knitr::rmarkdown}   %\usepackage[utf8]{inputenc}
---
...
db_clone <- calcDBClonalConsensus(db, regionDefinition=IMGT_V_NO_CDR3, 
...
`calcDBObservedMutations` is used to calculate the number of observed mutations 
...
db_obs <- calcDBObservedMutations(db_clone, sequenceColumn="CLONAL_CONSENSUS_SEQUENCE",
                                  regionDefinition=IMGT_V_NO_CDR3, nproc=3)
# Calculate expected mutations and add EXPECTED columns to db_obs
db_exp <- calcDBExpectedMutations(db_obs, sequenceColumn="CLONAL_CONSENSUS_SEQUENCE",
