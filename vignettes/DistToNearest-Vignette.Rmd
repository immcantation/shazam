...
library(ggplot2)
p1 <- ggplot() + theme_bw() + ggtitle("Distance to nearest: m1n") + xlab("distance") +
    geom_histogram(data=dist_m1n, aes(x=DIST_NEAREST), binwidth=0.025, fill="steelblue", color="white") +
...
p2 <- ggplot() + theme_bw() + ggtitle("Distance to nearest: hs5f") + xlab("distance") +
    geom_histogram(data=dist_hs5f, aes(x=DIST_NEAREST), binwidth=1, fill="steelblue", color="white") +
