...
To cite the HKL_S1F, HKL_S5F, MK_RS1NF, and MK_RS5NF models, please use:
  ...
  *197*(9), 3566-3574. doi:10.4049/jimmunol.1502263 <https://doi.org/10.4049/jimmunol.1502263>.

To cite the mixture model for threshold determination, please use:

  Nouri N, Kleinstein S (2018). “Optimized Threshold Inference for Partitioning of Clones From High-Throughput B Cell Repertoire
  Sequencing Data.” _Frontiers in Immunology_, *9*. doi:10.3389/fimmu.2018.01687 <https://doi.org/10.3389/fimmu.2018.01687>.
