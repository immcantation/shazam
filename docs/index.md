...
To cite the SHazaM package in publications, please use:
  ...
  Gupta N, Vander Heiden J, Uduman M, Gadala-Maria D, Yaari G, Kleinstein S (2015). â€œChange-O: a toolkit for analyzing
  large-scale B cell immunoglobulin repertoire sequencing data.â€ _Bioinformatics_, 1-3. doi:10.1093/bioinformatics/btv359
  <https://doi.org/10.1093/bioinformatics/btv359>.

To cite the selection analysis methods, please use:

  Yaari G, Uduman M, Kleinstein S (2012). â€œQuantifying selection in high-throughput Immunoglobulin sequencing data sets.â€
  _Nucleic acids research_, *40*(17), e134. doi:10.1093/nar/gks457 <https://doi.org/10.1093/nar/gks457>.
...
To cite the HH_S5F model and the targeting model generation methods, please use:
  ...
  Kleinstein S (2013). â€œModels of somatic hypermutation targeting and substitution based on synonymous mutations from
  high-throughput immunoglobulin sequencing data.â€ _Frontiers in Immunology_, *4*(358), 1-11. doi:10.3389/fimmu.2013.00358
...
To cite the HKL_S1F, HKL_S5F, MK_RS1NF, and MK_RS5NF models, please use:
  ...
  (2016). â€œA Model of Somatic Hypermutation Targeting in Mice Based on High-Throughput Ig Sequencing Data.â€ _The Journal of
  Immunology_, *197*(9), 3566-3574. doi:10.4049/jimmunol.1502263 <https://doi.org/10.4049/jimmunol.1502263>.
