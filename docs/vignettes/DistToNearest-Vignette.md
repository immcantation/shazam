...
`Example10x` containing single-cell paired IGH:IGK/IGL, TRB:TRA, or TRD:TRG chain sequences are 
...
Under the single-cell mode, each row of the input `Example10x` should represent a sequence/chain. 
