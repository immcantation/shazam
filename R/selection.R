...
#' 
#' @param    targeting   \code{\link{TargetingModel}} targeting slot with 
...
#' writeTargetingModel(HS5FModel@targeting, out_name='hs5f.tab') 
#' } 
#' @export
writeTargetingModel <- function(targeting, out_dir=getwd(), out_name='Targeting.tab') {
  to_write <- as.data.frame(targeting)
...
getObservedMutationsByCodon <- function(listMutations){
  ...
  temp <- lapply(1:length(listMutations), function(i){
    ...
    if(any(RPos)){################################################################################
                  ...
                  #
                  # You are free to share (copy, distribute and transmit) and adapt the work
                  ...
                  # Copyright 2013 Kleinstein Lab
                  # Version: 1.3 (01/30/2014)
                  ################################################################################
