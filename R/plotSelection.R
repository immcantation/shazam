...
#' @export
plotSelection <- function(db, groups=NULL, colors=NULL, main_title="Selection Strength",
                               legend_title=NULL) {
  ...
  plotCDR <-  ggplot(db, aes_string(x=groups, y="CDR_Sigma")) +
              ...
              geom_point(aes_string(color=groups), size=3, shape=21, fill="white")
  plot(plotCDR)
